...
import { IEditProjectPayload, IProjectResponse } from "@/types/project.type"
...
const formSchema = z.object({
    ...
    pc_preview: z.instanceof(File).optional(),
    mobile_preview: z.instanceof(File).optional(),
...
export function EditProjectForm({ project }: Props) {
    ...
    // states
    const [newTags, setNewTags] = useState<string[]>(project.tags);
    const [tab, setTab] = useState<string>("description");
    const [isSubmitting, setIsSubmitting] = useState(false);
    const [mobilePreview, setMobilePreview] = useState<string | null>(project.mobile_preview);
    const [pcPreview, setPcPreview] = useState<string | null>(project.pc_preview)
    ...
    const editProjectMutation = useMutation({
        mutationFn: (payload: IEditProjectPayload) => editProject(payload, project),
        onSuccess: () => {
